...
*
*/
Employee* employee_newParametros(char* idStr, char* nombreStr, char* horasTrabajadasStr) // ACA LOS DATOS HAY QUE PASARSELO A LA LISTA LINKED LIST, SERIA ASI SI FUERAN LISTAS ESTATICAS DE TIPO EMPLOYEE [5]
{
    int id, horasT;
    ...
    if ( this != NULL)// SIEMPRE HAY QUE PREGUNTAR POR NULL YA QUE MALLOC EN LA RESERVA DE MEMORIA DINAMICA DEVUELVE NULL SI HAY ERROROR!!!
    {
        ...
        employee_calcularSueldo(this, horasT); // CALCULA EL SUELDO!
...
int employee_calcularSueldo(Employee* this, int horasTrabajadas)
{
    int auxSueldo;
    int retorno=-1;
...
int retorno = -1;
    ...
    if(pFile!=NULL)
    {
        ...
        while(!feof(pFile))
        {
            ...
            {
                ll_add(pArrayListEmployee, pEmpleado); // CO
...
*
*/
Employee* employee_newParametrosDos(char* idStr, char* nombreStr, char* horasTrabajadasStr, char* sueldoStr) // ACA LOS DATOS HAY QUE PASARSELO A LA LISTA LINKED LIST, SERIA ASI SI FUERAN LISTAS ESTATICAS DE TIPO EMPLOYEE [5]
{
